...
This project is an MCP (Multi-Agent Conversation Protocol) Server for the given OpenAPI URL - https://api.apis.guru/v2/specs/googleapis.com/admob/v1beta/openapi.json, auto-generated using AG2's [MCP builder](https://mcp.ag2.ai).
